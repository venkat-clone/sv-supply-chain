    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6 font-sans">
          ...
          <span className="text-lg font-medium text-gray-700">
            ...
            {/* Hero Section */}
            <div className="relative bg-gray-200 rounded-xl overflow-hidden mb-8 shadow-lg">
                <img
                ...
                <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-start p-8">
                    <div>
                        ...
                        <p className="text-xl text-white mt-3 max-w-md">
                            Streamline your shipping with reliable and efficient services. Book loads today for seamless logistics management.
                        </p>
                        <Button className="mt-6 bg-blue-600 text-white hover:bg-blue-700 px-6 py-3 text-lg rounded-full shadow-md transition-all">
                            Book Your Load
                        </Button>
                    </div>
                </div>
                ...
                <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            ...
                            />
                            <Button className="w-full bg-blue-600 text-white hover:bg-blue-700 py-3 rounded-lg transition-colors">
                                Track
                            </Button>
                        </div>
                    </CardContent>
